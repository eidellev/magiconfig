 ...
 * @param   {Boolean}           [params.doTypeValidation]   Should validate config object property types (works in conjunction with template)
...
function magiconfig (params) {
    ...
    helper.validateAgainstTemplate(envConfig, template, params.doTypeValidation || false)
